...
namespace LiquidVictor.Data.Hardcoded
{
    public class SlideDeckRepository : Interfaces.ISlideDeckRepository
    {
        public SlideDeck GetSlideDeck(Guid id)
        {
            ...
            {
                slides.Add(10, new Slide()
                {
                    Title = "Full Screen Slide",
                    ContentText = new string[] { "* Bullet Point 1\r\n", "* Bullet Point 2" },
                    Layout = Enumerations.Layout.FullPage
                });

                slides.Add(15, new Slide()
                {
                ...
                slides.Add(20, new Slide()
                {
                    Title = "Image-Right Slide",
                    ContentText = new string[] { "* Bullet Point 3\r\n", "* Bullet Point 4" },
                    PrimaryImage = new Entities.PresentationImage()
                    {
                        Name = @"Canis Latrans",
                        Content = System.IO.File.ReadAllBytes(@"..\..\..\..\..\Media\CanisLatrans_small.jpg"),
                        ImageFormat = "image/jpeg"
                    },
                    Layout = Enumerations.Layout.ImageRight
                });

                slides.Add(30, new Slide()
                {
                    Title = "Image-Left Slide",
                    ContentText = new string[] { "* Bullet Point 5\r\n", "* Bullet Point 6\r\n", "* Bullet Point 7\r\n", "* Bullet Point 8\r\n", "* Bullet Point 9\r\n", "* Bullet Point 10" },
                    PrimaryImage = new Entities.PresentationImage()
                    {
                        Name = @"Carl Sagan",
